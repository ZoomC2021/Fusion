...
export const CLI_PROVIDER_ROUTING_CENSUS: readonly CliProviderRouting[] = [
  ...
  // FNXC:DevinCli 2026-09-06-04:36: The local Devin provider is admitted through the vendored pi registry extension.
  { providerId: "devin-cli", classification: "registry-native", autoDerive: "n/a", guardNotApplicable: "n/a", onExplicitHint: "n/a", fallbackPolicy: "none", rationale: "Vendored pi extension resolves through pi's registry." },
